      ...
      <AnimatePresence>
        {isToastVisible && (
          <motion.div 
            ...
            className="fixed bottom-6 right-6 z-50 bg-[#09090b] border-2 border-emerald-500/50 text-emerald-300 font-sans px-5 py-3 rounded-2xl shadow-2xl flex items-center space-x-3"
          >
